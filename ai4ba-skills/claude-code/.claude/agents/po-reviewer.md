...
1) **Value scan.** Doc state rõ ai benefit + how? Benefit measurable?
2) **Scope scan.** Scope grow beyond BRD/PRD justify? Features "snuck in"?
3) **Priority scan.** P0/P1/P2 make sense? P0 truly minimum-viable? P0 items có thể là P1?
4) **ROI scan.** Complexity match value? Build $$ for $ benefit?
5) **Stakeholder scan.** Key personas/users represented? Group nào ignored?
