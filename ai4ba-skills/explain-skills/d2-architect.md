...
**Nhưng ra được ảnh chỉ chứng minh CÚ PHÁP đúng, không chứng minh sơ đồ khớp hệ thống thật.** Máy không biết hệ thống của bạn thực sự gồm những khối nào — một sơ đồ thiếu hẳn một dịch vụ, hoặc vẽ hai khối nối với nhau trong khi thực tế chúng không hề trao đổi, vẫn cho ra hình đẹp bình thường. Phần đối chiếu với hệ thống thật vẫn cần bạn (hoặc dev/kiến trúc sư) xác nhận.
