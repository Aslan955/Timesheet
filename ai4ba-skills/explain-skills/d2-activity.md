...
**Nhưng đừng hiểu nhầm: ra được ảnh chỉ chứng minh CÚ PHÁP đúng, không chứng minh NGHIỆP VỤ đúng.** Máy chỉ biết bạn viết có hợp lệ không; nó không biết quy trình thật của bạn chạy thế nào. Một sơ đồ thiếu hẳn một nhánh rẽ, quên đường quay lại khi bị từ chối, hoặc vẽ một bước sai người phụ trách — vẫn cho ra tấm hình đẹp như thường.

Vì vậy khi nhận được ảnh, bạn vẫn nên tự soi ba câu: **mọi nhánh rẽ đã có đủ đường ra chưa** (nhánh "không đồng ý" đi đâu?), **có bước nào cụt không** (vào rồi không ra được), và **mỗi bước đã đúng người/bộ phận làm chưa**. Đây là phần máy không kiểm hộ được.
